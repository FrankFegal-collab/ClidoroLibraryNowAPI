using ClidoroLibraryNowAPI.Models;
...
public class BooksController : ControllerBase
{
    ...
    {
         new Book { Id = 1, Title = "The Subtle Art of Not Giving a F*ck", Author = "Mark Manson", Genre = "NONFICTION", Available = true, PublishedYear = 2016 },
         new Book { Id = 2, Title = "Alices adventures in wonderland", Author = "Lewis Carroll", Genre = "FICTION", Available = true, PublishedYear = 2017 }
    };
